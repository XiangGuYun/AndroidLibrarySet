...
interface BmpUtils {
     ...
     * 显示网络图片
     */
//    fun showBitmap(ctx: Context, iv: ImageView, imgUrl: String, placeImg: Int = HomeActivity.ERROR_IMG,
//                   errorImg: Int = HomeActivity.ERROR_IMG) {
//        Glide.with(ctx).load(imgUrl).apply(RequestOptions().placeholder(placeImg)
//                .error(errorImg)
//                //.override(320, 240).
...
//    }
     ...
     * @param imgUrl
     */
//    fun showCircleBitmap(ctx: Context, iv: CircleTextImageView, imgUrl: String, placeImg: Int, errorImg: Int) {
//        Glide.with(ctx)
//                .load(imgUrl)
//                .apply(RequestOptions().error(errorImg))
//                .into(iv)
//    }
