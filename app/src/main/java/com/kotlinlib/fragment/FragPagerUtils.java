...
public class FragPagerUtils<T extends Fragment>{
    ...
    public class FragAdapter extends FragmentStatePagerAdapter {
        ...
        public void destroyItem(ViewGroup container, int position, Object object) {
            //防止Fragment被销毁
            //这句代码可以在刷新ViewPager时防止Fragment出现重影
            //但是添加了新的Fragment后不会保留旧的Fragment的状态
//            if(object instanceof HouseFormFragment){
//                HouseFormFragment frag = (HouseFormFragment) object;
//                if(!frag.isAdd()){//因此只有在Fragment被删除后才调用这句代码
